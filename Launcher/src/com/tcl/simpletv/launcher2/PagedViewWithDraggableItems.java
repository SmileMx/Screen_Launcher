...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    public boolean onLongClick(View v) {
        ...
        // When we have exited all apps and is Edit State or are in transition, disregard long clicks
        // modified by leixp 2013--7-29
        if ((!mLauncher.isAllAppsVisible() && !mLauncher.isEditState())|| 
