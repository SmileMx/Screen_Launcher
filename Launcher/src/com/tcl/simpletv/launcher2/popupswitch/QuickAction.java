...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	private List<ActionItem> PopuItems = new ArrayList<ActionItem>();
	 ...
	 */
	public ActionItem getPopuItem(int index) {
	 ...
	 *            {@link ActionItem}
	 */
	public void addPopuItem(ActionItem action) {
		...
		if (mTrack.getChildCount() > 0) {
			Drawable line = mContext.getResources().getDrawable(
					R.drawable.gl_quickaction_line);
			ImageView separator = new ImageView(mContext);
			separator.setImageDrawable(line);
