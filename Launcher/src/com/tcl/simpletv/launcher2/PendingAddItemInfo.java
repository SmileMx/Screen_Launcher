...
class PendingAddItemInfo extends ItemInfo {
    ...
    public boolean isLocalWidget = false;
}
...
class PendingAddWidgetInfo extends PendingAddItemInfo {
    ...
    LocalWidgetInfo localWidgetInfo;
    LocalWidgetView localWidgetView;
    ...
    public PendingAddWidgetInfo(PendingAddWidgetInfo copy) {
        ...
        isLocalWidget = copy.isLocalWidget;
        localWidgetInfo = copy.localWidgetInfo;
        localWidgetView = copy.localWidgetView;
    }

    // Copy constructor
    public PendingAddWidgetInfo(LocalWidgetInfo i, String dataMimeType, Parcelable data) {

    	isLocalWidget = true;
    	
        itemType = LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET;
//    	        this.info = i;
        this.localWidgetInfo = i;
        componentName = i.provider;
        minWidth = i.minWidth;
        minHeight = i.minHeight;
        minResizeWidth = i.minResizeWidth;
