 ...
 *
 */
public abstract class ToolbarPagedViewWithDraggableItems extends TTPagedView
    implements View.OnLongClickListener, View.OnTouchListener {
	private String TAG="ToolbarPagedViewWithDraggableItems";
...
//    private Launcher mLauncher;
    ...
    public ToolbarPagedViewWithDraggableItems(Context context) {
        this(context, null);
    }

    public ToolbarPagedViewWithDraggableItems(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ToolbarPagedViewWithDraggableItems(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        Log.d(TAG, "PagedViewWithDraggableItems(Context context, AttributeSet attrs, int defStyle)");
