 ...
 */
public class ToolbarPagedViewCellLayoutChildren extends ViewGroup {
	static final String TAG = "ToolbarPagedViewCellLayoutChildren";
	...
	public ToolbarPagedViewCellLayoutChildren(Context context) {
		super(context);
	}
	...
	public void setGap(int widthGap, int heightGap) {
		Log.d(TAG, "mWidthGap = "+ widthGap+"   mHeightGap = "+heightGap);
		mWidthGap = widthGap;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		for (int i = 0; i < count; i++) {
			...
			ToolbarPagedViewCellLayout.LayoutParams lp = (ToolbarPagedViewCellLayout.LayoutParams) child
					.getLayoutParams();
			Log.d(TAG, "mCellWidth:" + mCellWidth + "    mCellHeight:" + mCellHeight
					+ "    mWidthGap:" + mWidthGap + "    mHeightGap:" + mHeightGap
					+ "    getPaddingLeft():" + getPaddingLeft() + "    getPaddingTop():"+getPaddingTop());
			lp.setup(mCellWidth, mCellHeight, mWidthGap, mHeightGap, getPaddingLeft(),
					getPaddingTop());
