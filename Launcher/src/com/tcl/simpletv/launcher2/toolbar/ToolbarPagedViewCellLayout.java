 ...
 */
public class ToolbarPagedViewCellLayout extends ViewGroup implements Page {
    static final String TAG = "ToolbarPagedViewCellLayout";
    ...
    private int mMaxGap;
    protected ToolbarPagedViewCellLayoutChildren mChildren;

    public ToolbarPagedViewCellLayout(Context context) {
        this(context, null);
    }

    public ToolbarPagedViewCellLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ToolbarPagedViewCellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOriginalCellWidth = mCellWidth =resources.getDimensionPixelSize(R.dimen.apps_customize_cell_width);//110
        mOriginalCellHeight = mCellHeight =resources.getDimensionPixelSize(R.dimen.apps_customize_cell_height);//100
        mCellCountX = 6;//LauncherModel.getCellCountX();
        mCellCountY = 2;//LauncherModel.getCellCountY();
        mOriginalWidthGap = mOriginalHeightGap = mWidthGap = mHeightGap = -1;
        mMaxGap= resources.getDimensionPixelSize(R.dimen.apps_customize_max_gap);//18

        mChildren = new ToolbarPagedViewCellLayoutChildren(context);
        mChildren.setCellDimensions(mCellWidth, mCellHeight);
        Log.d(TAG, "PagedViewCellLayout()");
    ...
    public boolean addViewToCellLayout(View child, int index, int childId,
            ToolbarPagedViewCellLayout.LayoutParams params) {
        final ToolbarPagedViewCellLayout.LayoutParams lp = params;
    ...
    public ToolbarPagedViewCellLayoutChildren getChildrenLayout() {
        return mChildren;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "onMeasure()"+"  mCellCountX="+mCellCountX+"  mCellCountY="+mCellCountY);
        int numWidthGaps = mCellCountX - 1;//6-1
        int numHeightGaps = mCellCountY - 1;//2-1
        Log.d(TAG, "mOriginalWidthGap="+mOriginalWidthGap+"    mOriginalHeightGap="+mOriginalHeightGap);
        if (mOriginalWidthGap < 0 || mOriginalHeightGap < 0) {
            ...
            mChildren.setGap(10, 1);//��ǰmChildren.setGap(28, 16);
//            mChildren.setGap(mWidthGap, mHeightGap);
        } else {
//            mWidthGap = mOriginalWidthGap;
//            mHeightGap = mOriginalHeightGap;
        	mWidthGap = Math.max(mOriginalWidthGap, 15);//真正间距修改地方
        	mHeightGap= Math.max(mOriginalHeightGap, 20);
        	mChildren.setGap(mWidthGap, mHeightGap);
        }
    ...
    public void setCellCount(int xCount, int yCount) {
        mCellCountX = xCount;
        mCellCountY = yCount;
        Log.d(TAG, "setCellCount()"+"  mCellCountX="+mCellCountX+"  mCellCountY="+mCellCountY);
        requestLayout();
    }
    ...
    public void setGap(int widthGap, int heightGap) {
        ...
        Log.d(TAG, "setGap(int widthGap, int heightGap)");
    ...
    void onDragChild(View child) {
        ToolbarPagedViewCellLayout.LayoutParams lp = (ToolbarPagedViewCellLayout.LayoutParams) child.getLayoutParams();
        lp.isDragging = true;
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ToolbarPagedViewCellLayout.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ToolbarPagedViewCellLayout.LayoutParams;
    }

    @Override
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        return new ToolbarPagedViewCellLayout.LayoutParams(p);
    }
