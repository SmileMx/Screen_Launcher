 ...
 */
public abstract class TTPagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
	private static final String TAG = "TTPagedView";
	...
	public TTPagedView(Context context) {
		this(context, null);
	}

	public TTPagedView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		Log.d(TAG, "PagedView(Context context, AttributeSet attrs)");
	}

	public TTPagedView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		Log.d(TAG, "PagedView(Context context, AttributeSet attrs, int defStyle)");

		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PagedView, defStyle, 0);
		setPageSpacing(Math.max(a.getDimensionPixelSize(R.styleable.PagedView_pageSpacing, 0), 100));
		mPageLayoutPaddingTop = a.getDimensionPixelSize(R.styleable.PagedView_pageLayoutPaddingTop,
				0);// 5dp
		mPageLayoutPaddingBottom = a.getDimensionPixelSize(
				R.styleable.PagedView_pageLayoutPaddingBottom, 0);// 5dp
		mPageLayoutPaddingLeft = a.getDimensionPixelSize(
				R.styleable.PagedView_pageLayoutPaddingLeft, 0);// 5dp
		mPageLayoutPaddingRight = a.getDimensionPixelSize(
				R.styleable.PagedView_pageLayoutPaddingRight, 0);// 5dp
		mPageLayoutWidthGap = a.getDimensionPixelSize(R.styleable.PagedView_pageLayoutWidthGap, 0);// 28dp
		mPageLayoutHeightGap = a
				.getDimensionPixelSize(R.styleable.PagedView_pageLayoutHeightGap, 0);// 16dp
		Log.d(TAG, "mPageLayoutWidthGap=" + mPageLayoutWidthGap + "    mPageLayoutHeightGap="
	...
	protected void setDataIsNoReady() {
		mIsDataReady = false;
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (childCount > 0) {
			...
			if (mPageSpacing == AUTOMATIC_PAGE_SPACING) {
				...
				Log.d(TAG, "onMeasure----------setPageSpacing(spacing);");
	...
	public void setPageSpacing(int pageSpacing) {
		Log.d(TAG, "public void setPageSpacing(int pageSpacing):" + pageSpacing);
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		for (int i = 0; i < childCount; i++) {
			...
			if (child.getVisibility() != View.GONE) {
				...
				Log.d(TAG, "onLayout( )mPageSpacing=" + mPageSpacing);
			}
		}
	...
	protected void snapToPageWithVelocity(int whichPage, int velocity) {
		...
		if (DEBUG)
			Log.d(TAG, "snapToPageWithVelocity.getRelativeChildOffset(): " + getMeasuredWidth()
	...
	protected void snapToPage(int whichPage, int duration) {
		...
		if (DEBUG)
			Log.d(TAG, "snapToPage.getChildOffset(): " + getChildOffset(whichPage));
		if (DEBUG)
			Log.d(TAG, "snapToPage.getRelativeChildOffset(): " + getMeasuredWidth() + ", "
					+ getChildWidth(whichPage));
	...
	protected void showScrollingIndicator(boolean immediately) {
		...
		if (mScrollIndicator != null) {
			...
			if (immediately || mScrollingPaused) {
				...
				mScrollIndicatorAnimator = ToolbarAnimUtils.ofFloat(mScrollIndicator, "alpha", 1f);// LauncherAnimUtils.ofFloat
	...
	protected void hideScrollingIndicator(boolean immediately) {
		...
		if (mScrollIndicator != null) {
			...
			if (immediately || mScrollingPaused) {
				...
				mScrollIndicatorAnimator = ToolbarAnimUtils.ofFloat(mScrollIndicator, "alpha", 0f);// LauncherAnimUtils.ofFloat
