...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    private View mTabsBgView; //标签布局空白填充图片 add by xiangss 20130831 
    ...
    protected void onFinishInflate() {
        ...
        //标签布局空白填充图片 add by xiangss 20130831
        mTabsBgView = mLayoutInflater.inflate(R.layout.tab_widget_bg, tabs, false);        
        tabs.addView(mTabsBgView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (remeasureTabWidth) {
            ...
            if (contentWidth > 0 && mTabs.getLayoutParams().width != contentWidth) {
            	...
            	//标签布局需要充满屏幕 add by xiangss 20130831 
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = visiblePages.size() - 1; i >= 0; i--) {
                    ...
                    mAnimationBuffer.setAlpha(0f);//mAnimationBuffer.setAlpha(1f);
