...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private TransitionDrawable mBgDrawable;	//增加背景图片切换
    ...
    protected void onFinishInflate() {
        ...
        mBgDrawable = (TransitionDrawable) r.getDrawable(R.drawable.drop_target_bg_delete);
        mBgDrawable.setCrossFadeEnabled(true);
    ...
    private void setHoverColor() {
        ...
        mBgDrawable.startTransition(mTransitionDuration);
    }
    private void resetHoverColor() {
        mCurrentDrawable.resetTransition();
        setTextColor(mOriginalTextColor);
        mBgDrawable.resetTransition();
    }
    ...
    public void deleteItem(DragObject d){
    	completeDrop(d);
    }
