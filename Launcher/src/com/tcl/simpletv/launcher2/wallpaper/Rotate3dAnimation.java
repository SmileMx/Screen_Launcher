...
public class Rotate3dAnimation extends Animation {
	 static final String TAG = "Rotate3dAnimation";
...
/*    public Rotate3dAnimation(float fromDegrees, float toDegrees,
   ...
   //     Log.v(TAG, " interpolatedTime =  " + interpolatedTime);        
        camera.save();        
        float curDepthZ = mDepthZ * interpolatedTime;        
        if (Math.abs(curDepthZ) < Math.abs(mDepthZ)) {
       // 	 Log.v(TAG, " curDepthZ  =  " + Math.abs(curDepthZ)+ " < mDepthZ = 80");
