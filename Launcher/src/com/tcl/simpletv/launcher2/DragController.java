...
public class DragController {
     ...
     * @param paramInt
     */
    public void startDrag(View paramView, DragSource dragSource, Object paramObject, int paramInt)
    {
    	
    	Bitmap localBitmap = getViewBitmap(paramView);
     	if (localBitmap == null)
     	{   	  
     		Log.e(TAG, "DragController startDrag bitmap == null!");
     		return;
     	}
     	int[] arrayOfInt = this.mCoordinatesTemp;
     	arrayOfInt[0] = ((int)this.mMotionDownX - paramView.getWidth() / 2);
     	arrayOfInt[1] = ((int)this.mMotionDownY - paramView.getHeight() / 2);

     	Rect dragRect = null;
     	dragRect = new Rect(0, 0, localBitmap.getWidth(), localBitmap.getHeight());
     	
     	startDrag(localBitmap, arrayOfInt[0], arrayOfInt[1], dragSource, paramObject, paramInt, null, dragRect,
     			 1);
    ...
    public void startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        //add for screenmanager by xssdmx 2013-07-24
        if((source instanceof ScreenManager) == false){
    ...
    private void endDrag() {
        if (mDragging) {
            ...
            if (!isDeferred) {
            	...
            	//add for screenmanager by xssdmx 2013-07-24
            	if((mDragObject.dragSource instanceof ScreenManager) == false){
	                for (DragListener listener : mListeners) {
	                    listener.onDragEnd();
	                }
            	}
    ...
    private void handleMoveEvent(int x, int y) {
        ...
        //add for screenmanager by xssdmx 2013-07-24
        if(dropTarget instanceof ScreenManager){
        	//Log.d(TAG, "handleMoveEvent----is ScreenManager, not need page scroll.");
        	return;
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mDragging) {
            	 ...
            	 //add for screenmanager by xssdmx 2013-07-24
            	 if(mLastDropTarget instanceof ScreenManager){                 	         	
                     drop(dragLayerX, dragLayerY);                     
                 }else{
    ...
    private DropTarget findDropTarget(int x, int y, int[] dropCoordinates) {
        ...
        for (int i=count-1; i>=0; i--) {
            ...
            //add for screenmanager by xssdmx 2013-07-24
            if(target instanceof ScreenManager){
            	//screenmanager not need find delete region.
              	 return target;
              }
