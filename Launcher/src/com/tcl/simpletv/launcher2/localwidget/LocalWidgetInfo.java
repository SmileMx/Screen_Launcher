...
public class LocalWidgetInfo implements Parcelable{

	public String localWidgetName;
    public int localWidgetId;
    public String localWidgetClassName;
    ...
    public LocalWidgetInfo() {
    }

    /**
     * Unflatten the WidgetInfo from a parcel.
     */
    public LocalWidgetInfo(Parcel in) {
        if (0 != in.readInt()) {
        ...
        this.localWidgetName = in.readString();
        this.localWidgetId = in.readInt();  
        this.localWidgetClassName = in.readString();
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        ...
        out.writeString(this.localWidgetName);
        out.writeInt(this.localWidgetId);     
        out.writeString(this.localWidgetClassName);
    }

    @Override
    public LocalWidgetInfo clone() {
    	LocalWidgetInfo that = new LocalWidgetInfo();
        ...
        that.localWidgetName = this.localWidgetName;
        that.localWidgetId = this.localWidgetId;
        that.localWidgetClassName = this.localWidgetClassName;
        return that;
    }
    ...
    /**
     * Parcelable.Creator that instantiates WidgetInfo objects
     */
    public static final Parcelable.Creator<LocalWidgetInfo> CREATOR
            = new Parcelable.Creator<LocalWidgetInfo>()
    {
        public LocalWidgetInfo createFromParcel(Parcel parcel)
        {
            return new LocalWidgetInfo(parcel);
        }

        public LocalWidgetInfo[] newArray(int size)
        {
            return new LocalWidgetInfo[size];
        }
    };

    public String toString() {
        return "WidgetInfo(provider=" + this.provider + ")";
    }
}
