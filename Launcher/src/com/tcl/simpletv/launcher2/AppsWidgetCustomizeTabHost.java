...
public class AppsWidgetCustomizeTabHost extends TabHost implements LauncherTransitionable,
TabHost.OnTabChangeListener  {
	static final String LOG_TAG = "AppsWidgetCustomizeTabHost";
    ...
    public AppsWidgetCustomizeTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        // Setup the tab host
    	Log.i("lxp","----AppsWidgetCustomizeTabHost--onFinishInflate->");
        setup();

        final ViewGroup tabsContainer = (ViewGroup) findViewById(R.id.tabs_tcl_container);
        final TabWidget tabs = getTabWidget();
        final AppsCustomizePagedView appsCustomizePane = (AppsCustomizePagedView)
                findViewById(R.id.apps_tcl_customize_pane_content);
        mTabs = tabs;
        mTabsContainer = tabsContainer;
        mAppsCustomizePane = appsCustomizePane;
        mAnimationBuffer = (FrameLayout) findViewById(R.id.animation_buffer_tcl);
        mContent = (LinearLayout) findViewById(R.id.apps_widget_customize_content);
        ...
        tabView = (TextView) mLayoutInflater.inflate(R.layout.tab_widget_edit_indicator, tabs, false);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	Log.i("lxp","----AppsWidgetCustomizeTabHost--onMeasure->");
        boolean remeasureTabWidth = (mTabs.getLayoutParams().width <= 0);
        //remeasureTabWidth = true;
        Log.i("lxp","----AppsWidgetCustomizeTabHost--onMeasure--remeasureTabWidth-->"+remeasureTabWidth);
    ...
    private void onTabChangedEnd(AppsCustomizePagedView.ContentType type) {
    	Log.i(LOG_TAG,"---in onTabChangedEnd--->");
        mAppsCustomizePane.setContentType(type);
    }

    @Override
    public void onTabChanged(String tabId) {
    	Log.i(LOG_TAG,"---in onTabChanged---->");
        final AppsCustomizePagedView.ContentType type = getContentTypeForTabTag(tabId);
        Log.i(LOG_TAG,"---in onTabChanged--type-->"+type);

        // Animate the changing of the tab content by fading pages in and out
        final Resources res = getResources();
        final int duration = res.getInteger(R.integer.config_tabTransitionDuration);
        Log.i(LOG_TAG,"---in onTabChanged--duration-->"+duration);
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                Log.i(LOG_TAG,"---in onTabChanged--visiblePages.size()-->"+visiblePages.size());
    ...
    void reset() {
    	Log.i(LOG_TAG,"----in reset-mInTransition-->"+mInTransition);
        if (mInTransition) {
    ...
    private void enableAndBuildHardwareLayer() {
    	Log.i(LOG_TAG,"---in enableAndBuildHardwareLayer--is Hardware Accelerated-> "+isHardwareAccelerated());
    ...
    public void onLauncherTransitionPrepare(Launcher l, boolean animated, boolean toWorkspace) {
        ...
        Log.i(LOG_TAG,"--in onLauncherTransitionPrepare---mResetAfterTransition->"+mResetAfterTransition);
